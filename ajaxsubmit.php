...
if ( isset( $_POST['email1'] ) ):
    ...
    $from_email = filter_var( $_POST['email1'], FILTER_SANITIZE_EMAIL );
    $number = filter_var( $_POST['phone1'], FILTER_SANITIZE_STRING );
    $message = filter_var( $_POST['message1'], FILTER_SANITIZE_STRING );
	$website = filter_var( $_POST['website1'], FILTER_SANITIZE_STRING );

    $to_email = "ektachd17@gmail.com";    // provide your target email address here
    $to_name = "Ekta";
	...
	if (!empty( $number )) {
        $email_body .= "Website: " . $website . " <br/><br/>";
    }
